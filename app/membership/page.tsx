const MembershipPage = () => {
  return (
    <div className="relative w-full h-full bg-[url('/membership-background.svg')] bg-center bg-contain -mt-6 px-32 py-16 flex flex-col gap-12 font-vietnam">
      <div className="absolute inset-0 bg-black bg-opacity-40 backdrop-blur-sm z-0"></div>
      <h1 className="text-[1.5rem] font-semibold uppercase text-secondaryLight text-center z-10 ">
        Membership Plans
      </h1>
