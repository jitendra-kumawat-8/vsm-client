  ...
  return (
    <div className="min-h-screen bg-primary py-16 font-vietnam text-secondaryLight border-b-4 border-secondaryLight">
      <div className="max-w-5xl mx-auto px-4">
        <h1 className="text-4xl font-[500]  text-center mb-16 ">
          OUR SERVICES
        </h1>

        <div className="space-y-24 font-[300]">
          <div className="bg-[#45133C] rounded-lg ">
            ...
            <p className="text-[1.3rem] text-secondaryLight">
          ...
          <div className="bg-[#45133C] rounded-lg ">
            ...
            <ul className="text-[1.3rem] text-secondaryLight space-y-2">
          ...
          <div className="bg-[#45133C] rounded-lg ">
            <h2 className="text-[1.5rem] font-[500]  mb-6 pl-3 leading-[3.2rem] w-full pr-[100px] bg-gradient-to-r from-[#290523] to-[#45133C]">
              Vedic Matchmaking
              <br /> Traditional Approach to Matchmaking in the Modern Context
            </h2>
            <p className="text-[1.3rem] text-secondaryLight">
